    ...
    public function createComponentArticleForm(): DynamicForm
    {
        return $this->dynamicFormFactory->create(
          function (DynamicForm $form) {
              ...
              $form->addSelect(ArticleRepository::COLUMN_PRIMARY_IMAGE_POS, 'Pozice obrázku', $this->imageService->positions)
                  ->setDefaultValue(array_key_first($this->imageService->positions))
                  ->setRequired(true);
